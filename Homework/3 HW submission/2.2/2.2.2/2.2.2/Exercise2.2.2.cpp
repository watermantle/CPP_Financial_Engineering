...
int main() {
	...
	//	Distance to origin for two points
	cout << "The distance bewteen " << P1.ToString() << " and origin is " << P1.DistanceOrigin() << endl;
	cout << "The distance bewteen " << P2.ToString() << " and origin is " << P2.DistanceOrigin() << endl;
