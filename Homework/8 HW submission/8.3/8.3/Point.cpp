...
namespace YuBai {
	namespace CAD {
		...
		Point::Point(const double& val_x, const double& val_y) : Shape(), m_x(val_x), m_y(val_y) {
			//cout << "Point has been created with given values.\n";
		}
		Point::Point(const Point& P) : Shape(P), m_x(P.m_x), m_y(P.m_y) {
			//cout << "Create a point with copy constructor\n";
		}
		Point::~Point() {
			//	Destructor with text
			//cout << "The point has been killed." << endl;
		}
		...
		void Point::Draw() const {
			cout << "The simulation of a point: .\n";
		}
		...
		Point& Point::operator = (const Point& source) {
			...
			//cout << "Point assignment operator was called\n";
