...
//	constructor to accpect single argument
Point::Point(const double& val_xy) : m_x(val_xy), m_y(val_xy) {
	//cout << ToString() << " has been created by new constructor\n";
}
//	Copy constructor
